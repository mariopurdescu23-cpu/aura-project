<script>
	...
	import imgWebsite from "$lib/assets/services/site-prezentare.jpg";
	import imgMagazin from "$lib/assets/services/magazin-online.jpg";
	import imgMobile from "$lib/assets/services/mobile-apps.jpg";
	import imgCrm from "$lib/assets/services/web-crm.jpg";
	import imgDesign from "$lib/assets/services/design-branding.jpg";
				...
				{#each services as service}
					...
					>
						<img
							src={service.image}
							alt={service.title}
							class="absolute inset-0 w-full h-full object-cover opacity-10 grayscale group-hover:opacity-20 transition-opacity duration-500 z-0 pointer-events-none"
						/>
						<div
