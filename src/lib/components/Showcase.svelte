		...
		<div class="relative w-full">
			...
			>
				{#each services as service}
					...
					>
						<svg
							class="w-12 h-12 md:w-14 md:h-14 mb-4 text-white/40 transition-all duration-300"
						...
						<p
							class="text-sm md:text-base text-white/40 font-sans leading-relaxed mb-4"
						>
							{service.desc}
						</p>
						<span
							class="inline-flex items-center gap-2 text-sm font-sans text-white/60 group-hover:text-white group-hover:gap-3 transition-all duration-300"
						>
							Află mai multe
							<svg
								class="w-4 h-4"
