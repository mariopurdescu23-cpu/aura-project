...
>
    ...
    >
        ...
        <div
            ...
            class="mt-8 flex flex-col md:flex-row gap-4 z-20 w-full sm:w-auto px-4 sm:px-0"
        >
            <a
                href="#work"
                onclick={(e) => scrollToSection(e, "#work")}
                class="px-8 py-4 bg-white text-black rounded-full font-sans font-medium hover:bg-[#3B82F6] hover:text-white transition-all duration-500 cursor-pointer shadow-[0_0_40px_rgba(255,255,255,0.15)] text-center"
            >
                Vezi Lucrările Selectate
            </a>
            <a
                href="#services"
                onclick={(e) => scrollToSection(e, "#services")}
                class="px-8 py-4 bg-transparent text-white border border-white/20 rounded-full font-sans font-medium hover:bg-[#3B82F6] hover:border-[#3B82F6] transition-all duration-500 cursor-pointer text-center"
            >
                Serviciile Noastre
            </a>
        </div>
