	...
	work: {
		...
		projects: [
			...
			},
			{
				id: "03",
				name: "Seeker România",
				category: "Vehicle History Platform",
				year: "2025",
				desc: "A carVertical-style vehicle history and verification platform, built for speed and trust at the exact moment someone checks a car.",
				tech: "SvelteKit · Vehicle data API",
				url: "https://seeker.ro",
			},
			{
				id: "04",
				name: "MysticPuff",
				category: "E-commerce — Vape Shop",
				year: "2025",
				desc: "A sleek online store for a vape and e-liquid brand, with a fast catalog, clean checkout and an age-gated shopping experience.",
				tech: "SvelteKit · E-commerce",
				url: "https://mysticpuff.ro",
			},
		],
	},
	capabilities: {
