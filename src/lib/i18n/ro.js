export const ro = {
	...
	work: {
		title1: "Lucrări",
		title2: "selectate.",
		desc: "O parte din produsele, platformele și experiențele pe care le-am livrat pentru clienți reali — treci cu mouse-ul pentru detalii, dă click pentru a vizita.",
