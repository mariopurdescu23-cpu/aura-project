	...
	work: {
		...
		projects: [
			...
			},
			{
				id: "03",
				name: "Seeker România",
				category: "Platformă verificare auto",
				year: "2025",
				desc: "O platformă de verificare a istoricului auto, în stilul carVertical, construită pentru viteză și încredere exact în momentul verificării unei mașini.",
				tech: "SvelteKit · API date auto",
				url: "https://seeker.ro",
			},
			{
				id: "04",
				name: "MysticPuff",
				category: "E-commerce — magazin vape",
				year: "2025",
				desc: "Un magazin online elegant pentru un brand de vape și lichide, cu catalog rapid, checkout simplu și verificare de vârstă la intrare.",
